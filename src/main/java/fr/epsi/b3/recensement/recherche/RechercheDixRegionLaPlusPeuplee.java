...
public class RechercheDixRegionLaPlusPeuplee extends MenuService {
    ...
    public void traiter(Recensement recensement) {
        ...
        Collections.sort(recensement.getListeRegions());
        for (int i = 0 ; i<10; i++){
            Region RegionPlusPeuplee = recensement.ListeRegions.get(i);
            System.out.println(RegionPlusPeuplee.nomRegion +" avec un total de "+RegionPlusPeuplee.populationTotale+ " habitants ");
